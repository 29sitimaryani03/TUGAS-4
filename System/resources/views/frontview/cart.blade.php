                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="{{url('public')}}/img/product-thumb-1.jpg" class="recent-thumb" alt="">
                        ...
                        <div class="woocommerce">
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="/single"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="{{url('public')}}/img/product-thumb-2.jpg"></a>
                                            </td>

                                            <td class="product-name">
                                                <a href="/single">Ship Your Idea</a> 
                                            </td>
                            ...
                            <div class="cross-sells">
                                ...
                                <ul class="products">
                                    <li class="product">
                                        <a href="/single">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="{{url('public')}}/img/product-2.jpg">
                                            <h3>Ship Your Idea</h3>
                                            <span class="price"><span class="amount">£20.00</span></span>
                                        </a>

                                        <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="22" rel="nofollow" href="/single">Select options</a>
                                    </li>

                                    <li class="product">
                                        <a href="/single">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="{{url('public')}}/img/product-4.jpg">
                                            <h3>Ship Your Idea</h3>
                                            <span class="price"><span class="amount">£20.00</span></span>
                                        </a>
